...
printingNameOfADarkRoomImpl = makeActivity printingNameOfADarkRoomName
        ignoreArgs
        ( do
            say "Darkness"
            return $ Just True
...
printingDescriptionOfADarkRoomImpl = makeActivity printingDescriptionOfADarkRoomName
        ignoreArgs
        ( do
...
printingNameOfSomethingImpl = makeActivity printingNameOfSomethingName
        singleArg
        ( do
...
describingLocaleActivityImpl =
    makeActivityEx describingLocaleActivityName
        (== 1)
        describeLocaleArgs
        []
        [ RuleWithVariables
