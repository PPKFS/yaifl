...
Which is a very roundabout way of finishing up rulebooks, aka modular functions, such that they completely contain their internal state and are opaquely identical

```haskell file=src/Yaifl/Core/Rulebooks/Args.hs
