...
- [The World Model](worldmodel.md)
  ...
  - [Objects](worldmodel/objects.md)
    ...
    - [ThingData and RoomData](worldmodel/objects/data.md)
    - [Object Specifics](worldmodel/objects/specifics.md)
    - [Dynamic Objects](worldmodel/objects/dynamic.md)
    - [Creating Objects](worldmodel/objects/creation.md)
    - [Moving Objects](worldmodel/objects/move.md)
  - [Rooms and Spatial Stuff](worldmodel/rooms.md)
    - [Directions](worldmodel/directions.md)
    - [Making Connections](worldmodel/connections.md)
  - [Properties](properties.md)
    - [Get, Set, Modify with TemplateHaskell](properties/getsetmodify.md)
    - [Standard Properties](properties/standard.md)
