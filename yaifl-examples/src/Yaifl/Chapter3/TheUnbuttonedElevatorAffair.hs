module Yaifl.Chapter3.TheUnbuttonedElevatorAffair where
...
theUnbuttonedElevatorAffairWorld = do
  ...
  uh <- addRoom "UNCLE Headquarters" $ newRoom
    & #description .~ [wrappedText|The steel nerve-center of the free world's battle against the Technological Hierarchy for
the Removal of Undesirables and the Subjugation of Humanity. Being against technology, we have only a very simple elevator to the east.|]
  dfts <- addRoom "Del Floria's Tailor Shop" $ newRoom
    & #description .~ [wrappedText|Only trained anti-THRUSH agents recognise the booth in the east wall as a secret elevator.|]
