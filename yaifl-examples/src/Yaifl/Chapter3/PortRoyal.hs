module Yaifl.Chapter3.PortRoyal where
...
The walls face the entrance to Port Royal Harbour, and the battery of guns is prepared to destroy any enemy ship arriving.|]
  ...
  ts <- addRoom "Thames Street End" $ newRoom & #description .~ [wrappedText|The ill-named Thames Street runs from here -- at the point of the peninsula --
...
runs directly south, and to the north the road opens up into the courtyard of Fort James.|]
  ...
  wl <- addRoom "Water Lane" $ newRoom & #description .~ [wrappedText|Here Thames Street -- never very straight -- goes steeply southeast for a portion
